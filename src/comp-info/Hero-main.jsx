...
import ParallaxModel from "./ParallaxModel-main.jsx";
    ...
    <div className="hero-root" onMouseMove={handleMouseMove}>
      ...
      <div className="hero-grid">
        <div className="hero-left">
          ...
          <div style={{ marginTop: 14, display: "flex", gap: "10px", flexWrap: "wrap" }}>
            <a
              ...
              role="button"
              aria-label="Buka halaman Visi dan Misi"
              onClick={(e) => {
                if (typeof window !== "undefined") {
                  window.location.hash = "#/visimisi";
                }
              }}
            >
              Visi & Misi
            ...
            <a
              ...
              className="visi-button"
              role="button"
              aria-label="Buka halaman Sejarah"
              onClick={(e) => {
                if (typeof window !== "undefined") {
        ...
        <div className="hero-right">
          <div className="hero-console glow-green">// console.log("Hello There")</div>
